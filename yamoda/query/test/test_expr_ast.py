...
valid_expressions = [
     ...
     ValidExpression("a if a > 4 else b", dict(a=3, b=0), 0, es),
     ValidExpression("a if a > 4 else b", dict(a=5, b=0), 5, es),
     ValidExpression("a if a < 4 else b", dict(a=5, b=1), 1, es),
     ValidExpression("a if a >= 4 else b", dict(a=5, b=0), 5, es),
     ValidExpression("a if a <= 4 else b", dict(a=5, b=0), 0, es),
     ValidExpression("a if a <= 4 else '-'", dict(a=5), "-", es),
