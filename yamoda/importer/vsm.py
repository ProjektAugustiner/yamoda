...
class Importer(ImporterBase):
    ...
    def default_context(cls):
        ...
        T1_desc = d("""\
        The *T1* variable represents the temperature of the capacitance
        thermometer.  Its advantage is the low magnetic field dependance. It is
        perfectly suited for magnetic field sweeps. It reacts slowly to large
        temperature changes, the resistive thermometer *T1* and *T2* are the
        better alternative for temperature sweeps.
        """)
        T1 = Parameter(name='T1', brief=T1_brief, description=T1_desc,
                       unit='K')
        T2_brief = 'Temperature of the resistive thermometer.'
        T2_desc = d("""\
        The *T2* variable represents the temperature of the resistive
        thermometer. It is mounted adjacent to the *T1* thermometer. Its
        strength is the short reaction time to temperature changes. It is the
        first choice for Temperature Sweeps.
        """)
        ...
        pickup coils, to achieve a more accurate sample Temperature.
        """)
        ...
        Tset_desc = d("""\
        *Tset* is the current target temperature used by the temperature
        controller.
        """)
        ...
        Tcontrol_desc = d("""\
        *Tcontrol* is the temperature used by the temperature controller. It
        tries to minimize the difference between *Tset* and *Tcontrol*
        (**Default**: *T2*).
        """)
        Tcontrol = Parameter(name='Tcontrol', brief=Tcontrol_brief,
                             description=Tcontrol_desc, unit='K')
        X_desc = d("""\
        *X* is the in phase magnetic induction signal. A SR830 Lock-In amplifier
        is used to measure the magnetic induction signal. The in-phase component
        represents the sample signal. With a reference measurement, typically a
        high purity Ni sample of known magnetic moment, the magnetic moment of
        ...
        H_desc = d("""\
        The VSM is equipped with a bipolar superconducting solenoid magnet. It
        is capable of delivering a magnetic field up to 9T.
        """)
        ...
        ### Note
        It does not neccessarily start at zero.
        """)
